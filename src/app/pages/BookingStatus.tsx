            ...
            <div className="bg-white rounded-lg shadow-lg p-8">
                  ...
                  <div className="flex items-center space-x-3">
                    ...
                    <div>
                      <p className="text-sm text-gray-600">
                        {booking.pickup_location ? 'Pickup Location' : 'Destination'}
                      </p>
                      <p className="font-semibold">
                        {booking.pickup_location || booking.destination || 'Not specified'}
                      </p>
                ...
                <div className="space-y-4">
                  ...
                  <div className="flex items-center space-x-3">
                    ...
                    <div>
                      ...
                      <p className="font-semibold">
                        {booking.number_of_persons || booking.passengers || booking.persons || 'Not specified'}
                      </p>
                    </div>
                  </div>

                  <div className="flex items-center space-x-3">
                    {getStatusIcon(booking.bookingStatus || booking.booking_status || 'pending')}
                    <div>
                      <p className="text-sm text-gray-600">Status</p>
                      <span className={`inline-flex items-center px-3 py-1 rounded-full text-sm font-medium border ${getStatusColor(booking.bookingStatus || booking.booking_status || 'pending')}`}>
                        {(booking.bookingStatus || booking.booking_status || 'pending').charAt(0).toUpperCase() + (booking.bookingStatus || booking.booking_status || 'pending').slice(1)}
                      </span>
                    </div>
                  </div>
                </div>
              ...
              {booking.trip_type && (
                <div className="mb-4">
                  ...
                  <p className="font-semibold">{booking.trip_type}</p>
                </div>
              )}
              ...
              {booking.return_date && (
                <div className="mb-4">
                  ...
                  <p className="font-semibold">{formatDate(booking.return_date)}</p>
                </div>
              )}
              ...
              {(booking.specialRequests || booking.additional_requirements) && (
                <div className="mb-4">
