      ...
      <div className="container mx-auto px-4 py-8">
        ...
        <div className="max-w-2xl mx-auto">
          <div className="text-center mb-8">
            ...
            {bookingId && (
              <div className="inline-block bg-blue-50 border border-blue-200 rounded-full px-6 py-2 mb-6 shadow-sm">
                <span className="text-blue-600 font-mono font-bold text-xl tracking-wider">
                  #{bookingId}
                </span>
              </div>
            )}
            ...
            <p className="text-lg text-gray-600 mb-6">
              ...
              {emailFailed ? (
                ...
                <span className="block mt-2">
                  A confirmation email with your journey details has been sent.
                </span>
              )}
            </p>
          </div>
