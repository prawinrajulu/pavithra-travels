        ...
        <div className="grid lg:grid-cols-2 gap-12">
              ...
              <div className="space-y-4">
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <a href="mailto:pavithratravelshoppee@gmail.com" className="text-gray-600 hover:text-amber-600">
                      pavithratravelshoppee@gmail.com
                    </a>
                  </div>
                </div>
          ...
          <div className="bg-white p-8 rounded-2xl shadow-lg">
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <button
                type="submit"
                className="w-full bg-[#FF8C00] text-white px-8 py-4 rounded-lg hover:bg-[#F28C00] transition-all shadow-lg hover:shadow-xl flex items-center justify-center gap-2 font-bold"
              >
